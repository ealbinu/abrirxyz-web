...
/**
  ...
  *
  * @checksum - eeb6a58a8a3da4fc53d537f4ac5dee081f229838c3cba24b39618c2a9a12778b
  * @variables - radius=rounded,accentColor=sky,colorTemperature=slate,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=500,borderShadeLightMode=100,borderShadeDarkMode=200,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:dark:border-slate-300": true
  },
  ...
  "color__inner": {
    ...
    "dark:group-data-[prefix-icon]:border-slate-200": true,
    "dark:group-data-[suffix-icon]:border-slate-200": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "dark:group-data-[multiple]:border-slate-300": true,
  ...
  "colorpicker__inner": {
    ...
    "group-data-[inline]:bg-zinc-100": true,
  ...
  "colorpicker__panel": {
    ...
    "dark:bg-slate-800": true,
    "dark:border-slate-200": true,
    "dark:group-data-[inline]:bg-zinc-100": true,
  ...
  "slider__minValue": {
    ...
    "dark:[&>div>div::after]:bg-slate-200": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:bg-zinc-100": true,
    "dark:disabled:bg-zinc-100": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "dark:ring-slate-400": true,
    "dark:data-[is-active=true]:ring-sky-400": true,
    "dark:aria-selected:ring-sky-400": true,
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-slate-300": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:text-slate-500": true,
    "dark:group-data-[tab-style=tab]/wrapper:bg-slate-950/20": true,
    "dark:group-data-[tab-style=tab]/wrapper:data-[active=true]:bg-zinc-100": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-slate-400": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:after:bg-slate-400": true,
  ...
  "multi-step__tabLabel": {
    ...
    "[line-height:1em]": true,
    "dark:group-data-[tab-style=progress]/wrapper:text-slate-500": true
  },
  "multi-step__badge": {
    "bg-red-500": true,
    "absolute": true,
